package pe.edu.pucp.a20152252.myfirstlogin.features.mainbar;
...
public class BarActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.home_lyt_frame, HomeFragment.newInstance());
